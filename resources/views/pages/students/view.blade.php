...
@section('content')
		...
		<div class = "row">
			<div class = "col-12">
				<h1 class = "custom-header">
					...
					<div class = "subtitle">Viewer | {{ $student->info_name_last }}, {{ $student->info_name_first }} {{ $student->info_name_middle }} {{ $student->info_name_suffix }}</div>
					<hr>
				</h1>
	...
	<div class = "container">
		<div class = "row">
			<div class = "col-12">
				<button class = "custom-button" type = "button" onclick = "window.print(); window.close();">Print</button>
			</div>
			<div class = "col-12">
				<br>
