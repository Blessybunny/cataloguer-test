<div class = "col-12">
	...
	<table class = "table">
		...
		<tr>
			...
			<td class = "align-middle debug-db" data-editable = "true" data-attribute = "ALL_g{{ $grade }}_subject_ap_qr1"></td>
			<td class = "align-middle debug-db" data-editable = "true" data-attribute = "ALL_g{{ $grade }}_subject_ap_qr2"></td>
			<td class = "align-middle debug-db" data-editable = "true" data-attribute = "ALL_g{{ $grade }}_subject_ap_qr3"></td>
			<td class = "align-middle debug-db" data-editable = "true" data-attribute = "ALL_g{{ $grade }}_subject_ap_qr4"></td>
		...
		<tr>
			...
			<td class = "align-middle debug-js" data-attribute = "ALL_g{{ $grade }}_subject_all_average"></td>
			<td class = "align-middle debug-js" data-attribute = "ALL_g{{ $grade }}_subject_all_remarks"></td>
		</tr>
		<tr>
