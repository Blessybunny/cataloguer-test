<div class = "col-12">
	...
	<table class = "table">
		...
		<tr>
			...
			<td class = "align-middle debug-has-db-assoc ALL_g{{ $grade }}_subject_all_average"></td>
			<td class = "align-middle debug-has-db-assoc ALL_g{{ $grade }}_subject_all_remarks"></td>
		</tr>
		<tr>
