		...
		<div class = "col-6">
			...
			<table class = "table">
				...
				<tr>
					...
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_md_s1_qr1"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_md_s1_qr2"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_md_s1_qr3"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_md_s1_qr4"></td>
				</tr>
				<tr>
					<td>Shows adherence to ethical principles by upholding truth.</td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_md_s2_qr1"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_md_s2_qr2"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_md_s2_qr3"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_md_s2_qr4"></td>
				</tr>
				<tr>
					<td class = "align-middle left" rowspan = "2">Maka - Tao</td>
					<td>Is sensitive to individual, social and cultural differences.</td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mt_s1_qr1"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mt_s1_qr2"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mt_s1_qr3"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mt_s1_qr4"></td>
				</tr>
				<tr>
					<td>Demonstrates contributions toward solidarity.</td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mt_s2_qr1"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mt_s2_qr2"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mt_s2_qr3"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mt_s2_qr4"></td>
				</tr>
				<tr>
					...
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mk_qr1"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mk_qr2"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mk_qr3"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mk_qr4"></td>
				</tr>
				<tr>
					...
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mb_s1_qr1"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mb_s1_qr2"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mb_s1_qr3"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mb_s1_qr4"></td>
				</tr>
				<tr>
					<td>Demonstrates appropriate behavior in carrying out activities in the school, community and country.</td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mb_s2_qr1"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mb_s2_qr2"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mb_s2_qr3"></td>
					<td class = "align-middle debug-field" data-interactive = "true" data-field = "SF9_g{{ $grade }}_values_mb_s2_qr4"></td>
				</tr>
			</table>
