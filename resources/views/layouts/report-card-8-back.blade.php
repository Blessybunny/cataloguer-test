<section class = "container paper">
	<div class = "row">
		...
		<div class = "col-6">
			...
			<h6 class = "align-middle custom-header-bg">Report on Learning Progress and Achievement</h6>
			...
			<table class = "table">
				...
				<tr>
					<th class = "align-middle report-card-width-thin">1st</th>
					<th class = "align-middle report-card-width-thin">2nd</th>
					<th class = "align-middle report-card-width-thin">3rd</th>
					<th class = "align-middle report-card-width-thin">4th</th>
				</tr>
				<tr>
					<td>Filipino 8</td>
				...
				<tr>
					<td>Edukasyon sa Pagpapakatao (EP) 8</td>
					<td class = "align-middle"></td>
					<td class = "align-middle"></td>
					<td class = "align-middle"></td>
					<td class = "align-middle"></td>
		...
		<div class = "col-6">
			...
			<h6 class = "align-middle custom-header-bg">Report on Learner's Observed Values</h6>
			...
			<table class = "table">
				<tr>
					<th class = "align-middle report-card-width-wide uppercase">Markings</th>
